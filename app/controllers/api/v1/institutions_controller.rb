  ...
  module V1
    class InstitutionsController < ApplicationController
      ...
      def index
        ...
        render json: CommonRepresenter.new(data: InstitutionsRepresenter.new(@institutions).as_json, meta: [@institutions.current_page, @institutions.limit_value, @institutions.total_pages, @institutions.total_count]).as_json
      ...
      def create
        ...
        if @institution.save
          render json: CommonRepresenter.new(data: InstitutionRepresenter.new(@institution).as_json, code: 201).as_json, status: :created
        else
      ...
      def show
        render json: CommonRepresenter.new(data: InstitutionRepresenter.new(@institution).as_json).as_json
      end
